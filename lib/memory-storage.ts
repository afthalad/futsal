...
// User operations
export const createUserInMemory = (
...
// Ground operations
export const createGroundInMemory = (
...
export const getGroundsByOwnerInMemory = (ownerId: string): Ground[] => {
  return Array.from(
    storage.grounds.values() as IterableIterator<Ground>,
  ).filter((ground) => ground.ownerId === ownerId);
};

export const updateGroundInMemory = (
  id: string,
...
export const updateBookingInMemory = (
  id: string,
...
// Booking operations
export const createBookingInMemory = (
...
export const getAllBookingsInMemory = (): Booking[] => {
  return Array.from(
    storage.bookings.values() as IterableIterator<Booking>,
