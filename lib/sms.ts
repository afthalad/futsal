...
export async function sendBookingNotification(
  ...
  try {
    ...
    const result = await sendBookingNotificationSMS(
      phone,
      groundName,
      date,
      startTime,
...
export async function sendBookingConfirmationToCustomer(
  ...
  try {
    const result = await sendBookingConfirmationToCustomerSMS(
      phone,
      groundName,
      date,
      startTime,
...
export async function sendBookingConfirmationToOwner(
  phone: string,
  groundName: string,
  date: string,
  startTime: string,
  ...
  try {
    const result = await sendBookingConfirmationToOwnerSMS(
      phone,
      groundName,
      date,
      startTime,
...
export async function sendBookingCancellationSMS(
  ...
  try {
    ...
    const result = await sendBookingCancellationToCustomer(
      phone,
      customerName,
      groundName,
      date,
