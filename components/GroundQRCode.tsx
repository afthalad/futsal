...
export default function GroundQRCode({ groundId, groundName, isOpen, onClose }: GroundQRCodeProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <div className="text-center mb-6">
          <h4 className="text-sm font-medium text-gray-700 mb-2">{groundName}</h4>
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
          <p className="text-xs text-gray-600 text-center">
            ...
            <span className="font-mono text-xs break-all">
              {typeof window !== 'undefined' ? `${window.location.origin}/grounds/${groundId}` : ''}
            </span>
          </p>
        </div>
      </div>
