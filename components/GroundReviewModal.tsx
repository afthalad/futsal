...
import { X, MapPin, Phone, Clock, DollarSign, Star, Check, XCircle, User, Calendar } from 'lucide-react'
...
interface GroundReviewModalProps {
  isOpen: boolean
  onClose: () => void
  ground: Ground | null
...
export default function GroundReviewModal({
  isOpen,
  onClose,
  ground,
  onApprove,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Review Ground</h2>
            <p className="text-gray-600 mt-1">Review all details before approving or rejecting</p>
          </div>
          <button
            onClick={handleClose}
